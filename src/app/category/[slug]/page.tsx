    ...
    <div className="min-h-[80vh]">
      ...
      <div className={`relative overflow-hidden bg-gradient-to-br ${meta.headerBg}`}>
        ...
        <div className="relative mx-auto max-w-5xl px-4 pt-8 pb-12 sm:px-6 sm:pt-12 sm:pb-16">
          <Link href="/" className={`inline-flex items-center gap-1.5 text-sm ${meta.accent} hover:opacity-80 mb-6 transition-opacity`}>
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              ...
              <p className={`mt-3 max-w-2xl text-sm ${meta.accent} leading-relaxed sm:text-base`}>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-amber-600">Featured Tool</span>
