          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={downloadCSV} className="text-xs font-semibold text-white px-3 py-1.5 rounded-lg shadow-sm hover:shadow-md transition-all" style={{ backgroundImage: "linear-gradient(90deg, #1D4ED8 0%, #6D28D9 50%, #DB2777 100%)" }}>Download .csv</button>
              </div>
            </div>
