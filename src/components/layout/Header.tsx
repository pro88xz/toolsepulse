...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 bg-white/80 backdrop-blur-md">
      <div className="flex h-16 w-full items-center justify-between px-[clamp(16px,2.1vw,40px)]">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-slate-200 bg-white px-4 py-3 animate-in slide-in-from-top">
          <nav className="space-y-1">
            {[
              { href: "/games", label: "🎮 Games", icon: "M6.75 7.5h10.5a3.75 3.75 0 0 1 3.697 4.386l-.61 3.66A2.25 2.25 0 0 1 18.117 17.4a2.25 2.25 0 0 1-1.767-.86l-1.02-1.29a1.5 1.5 0 0 0-1.178-.57H9.848a1.5 1.5 0 0 0-1.178.57l-1.02 1.29a2.25 2.25 0 0 1-1.767.86 2.25 2.25 0 0 1-2.22-1.854l-.61-3.66A3.75 3.75 0 0 1 6.75 7.5Zm1.5 3v1.5m-.75-.75h1.5m6 0h.008v.008H15v-.008Zm2.25-1.5h.008v.008h-.008V9Z" },
