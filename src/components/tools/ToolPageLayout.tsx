...
const toolIcons: Record<string, string> = {
  ...
  "pdf-splitter": "M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z",
  ...
  "image-cropper": "M7.5 3.75H6A2.25 2.25 0 0 0 3.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0 1 20.25 6v1.5m0 9V18A2.25 2.25 0 0 1 18 20.25h-1.5m-9 0H6A2.25 2.25 0 0 1 3.75 18v-1.5M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z",
  ...
  "video-trimmer": "M3 12h18M7 6v12M17 6v12",
  // Converter
  ...
  "audio-trimmer": "M3 12h18M7 6v12M17 6v12",
      ...
      <div className="mx-auto max-w-4xl px-4 pt-10 pb-6 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className={`inline-flex rounded-xl p-3 ${categoryIconColors[tool.category]} mb-4`}>
            <svg className="h-8 w-8" overflow="visible" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
              ...
              <div className="mb-12">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {useCases.filter((uc) => uc.toolSlug === tool.slug).map((uc) => (
                    ...
                    >
                      <h3 className="text-sm font-semibold text-gray-900 group-hover:text-purple-700 transition-colors">{uc.title}</h3>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {comparisons.filter((c) => c.ctaToolSlug === tool.slug).map((c) => (
                    <Link
                      ...
                      className="rounded-xl border border-gray-200 bg-white p-4 hover:border-blue-300 hover:shadow-md transition-all group"
                    >
                      <h3 className="text-sm font-semibold text-gray-900 group-hover:text-purple-700 transition-colors">{c.title}</h3>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <Link href={`/tools/${tool.slug}/how-to`} className="rounded-2xl border border-gray-200 bg-white p-6 hover:border-blue-300 hover:shadow-lg hover:-translate-y-0.5 transition-all group">
                ...
                <h4 className="text-sm font-bold text-gray-900 group-hover:text-purple-700">Full Step-by-Step Guide</h4>
              ...
              <Link href={`/tools/${tool.slug}/faq`} className="rounded-2xl border border-gray-200 bg-white p-6 hover:border-blue-300 hover:shadow-lg hover:-translate-y-0.5 transition-all group">
                ...
                <h4 className="text-sm font-bold text-gray-900 group-hover:text-purple-700">Frequently Asked Questions</h4>
              ...
              <Link href={`/tools/${tool.slug}/alternatives`} className="rounded-2xl border border-gray-200 bg-white p-6 hover:border-blue-300 hover:shadow-lg hover:-translate-y-0.5 transition-all group">
                ...
                <h4 className="text-sm font-bold text-gray-900 group-hover:text-purple-700">Compare Alternatives</h4>
                    ...
                    return (
                      <Link key={slug} href={`/tools/${slug}`} className="flex items-center gap-4 rounded-xl border border-gray-200 bg-white p-4 hover:border-blue-300 hover:shadow-md transition-all group">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-sm font-semibold text-gray-900 group-hover:text-purple-700 transition-colors">{related.name}</h3>
                          <p className="text-xs text-gray-500 truncate">{related.shortDescription}</p>
                        </div>
                        <svg className="h-4 w-4 text-gray-300 group-hover:text-purple-700 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                      </Link>
                    );
                  })}
                </div>
